...
public abstract class Game {
    ...
    protected PrivateGuild allocatePrivateGuild() throws UserFriendlyException {
        final AvailablePrivateGuildQueue availablePrivateGuildQueue = Launcher.getBotContext().getAvailablePrivateGuildQueue();
        PrivateGuild pg = availablePrivateGuildQueue.poll();
        if (pg == null) {
            ...
            try { //oh yeah...we are waiting till infinity if necessary
                pg = availablePrivateGuildQueue.take();
