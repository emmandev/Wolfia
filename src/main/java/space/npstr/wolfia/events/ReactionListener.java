...
public class ReactionListener extends ListenerAdapter {
    ...
    public ReactionListener(final Message message, final Predicate<Member> filter, final Consumer<GenericMessageReactionEvent> callback,
        ...
        Launcher.getBotContext().getScheduler().getScheduler().schedule(this::destruct, selfDestructMillis, TimeUnit.MILLISECONDS);
    }

    protected void destruct() {
        //remove the listener
        Launcher.getBotContext().getListenerRegistry().removeListener(this);
