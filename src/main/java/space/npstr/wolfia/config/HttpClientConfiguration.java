...
public class HttpClientConfiguration {
    ...
    @Bean
    public OkHttpClient defaultHttpClient(final OkHttpClient.Builder httpClientBuilder) {
        return httpClientBuilder
//                .eventListener(new Metrics.HttpEventListener("default")) todo add metrics
                .build();
    }
}
